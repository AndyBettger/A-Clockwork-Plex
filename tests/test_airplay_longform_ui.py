...
"""
    ...
    def test_episode_title_is_single_line_measured_marquee(self) -> None:
        ...
        self.assertIn("title.scrollWidth - title.clientWidth", client)
        self.assertIn("--airplay-title-overflow", client)
        self.assertIn("is-overflowing", client)
        self.assertIn("body.airplay-metadata-active .airplay-copy h1", style)
        self.assertIn("white-space: nowrap;", style)
        self.assertIn("@keyframes airplay-title-scroll", style)
        self.assertIn("text-indent: calc(-1 * var(--airplay-title-overflow", style)
