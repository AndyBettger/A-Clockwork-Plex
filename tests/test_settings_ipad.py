...
class SettingsIpadTests(unittest.TestCase):
    ...
    def test_news_settings_and_navigation_reuse_existing_owners(self):
        ...
        self.assertIn('data-settings-subpage-target="advanced:news-feeds"', self.news_settings)
        self.assertIn('data-settings-subpage="advanced:news-feeds"', self.news_settings)
