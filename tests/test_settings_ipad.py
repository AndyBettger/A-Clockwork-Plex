...
class SettingsIpadTests(unittest.TestCase):
    ...
    def test_news_settings_and_navigation_reuse_existing_owners(self):
        ...
        self.assertIn("advancedRow.dataset.settingsSubpageTarget = 'advanced:news-feeds';", self.news_settings)
        self.assertIn("advancedSubpage.dataset.settingsSubpage = 'advanced:news-feeds';", self.news_settings)
