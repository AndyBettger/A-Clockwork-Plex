...
class AirPlayControlCoordinationTests(unittest.TestCase):
    ...
    def test_disconnect_is_polled_from_sender_not_play_end_hook(self):
        ...
        self.assertNotIn("SESSION_END_WRAPPER_EOF", hook_text)
        self.assertNotIn('echo "    run_this_after_play_ends', hook_text)
        self.assertNotIn('echo "    session_timeout =', hook_text)
