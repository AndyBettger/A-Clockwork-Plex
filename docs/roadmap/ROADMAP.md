...
- [ ] Commissioned 1280×720 recheck confirms the compact News Feed order drag interaction, Enabled/Disabled control, normal Add BBC feed presentation/new-editor auto-scroll and Clock weather-card drag interaction, then completes custom-feed story QR, non-BBC rejection, cache-source correctness and touch/layout usability.
