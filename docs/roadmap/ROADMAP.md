...
- [x] **Provisional managed candidate:** advance **S32_LE / 192 kHz** to the wider functional gate, retaining **S32_LE / 96 kHz** as fallback if the broader stability/compatibility evidence favours it. This is not yet the final production managed-bus policy.
