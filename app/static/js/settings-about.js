...
(() => {
  ...
  if (window.__aClockworkPlexBackupRestoreClientRequested) return;
  window.__aClockworkPlexBackupRestoreClientRequested = true;

  const script = document.createElement('script');
  script.src = '/static/js/settings-backup-restore.js?v=20260910-controller-v1';
  script.async = false;
